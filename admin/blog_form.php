      ...
      <div class="page-content">
        ...
        <div class="page-header no-margin-bottom">
          <div class="container-fluid">
            <h2 class="h5 no-margin-bottom">Blog News Upload</h2>
          </div>
        </div>
        <!-- Breadcrumb-->
        <div class="container-fluid">
        ...
        <section class="no-padding-top">
          <div class="container-fluid">
            <div class="row">
              ...
              <div class="col-lg-12">
                <div class="block">
                  <div class="title" align="center"><strong class="d-block">Upload Article</strong><span class="d-block">Enter the latest updates.</span></div>
                  <div class="block-body">
                    <form>
                      <div class="form-group">
                        <label class="form-control-label">Tittle</label>
                        <input type="tittle" placeholder="Enter Tittle" class="form-control">
                      </div>
                      <div class="form-group">       
                        <label class="form-control-label">Description</label>
                        <textarea class="form-control input-xlarge" id="description" name="description" placeholder="Enter Article" rows="3"></textarea>
                      </div>
                      <div class="form-group">
                        <label class="form-control-label">Author Name</label>
                        <input type="author_name" placeholder="Enter Your Full Name" class="form-control">
                      </div>
                      <div class="form-group">       
                  ...
                  <div class="block-body">
                    <form class="form-inline">
                      <div class="form-group">
                        ...
                        <input id="inlineFormInput" type="text" placeholder="Manzuma Memunat" class="mr-sm-3 form-control">
                      </div>
                      <div class="form-group">
